...
export function SubscriptionStatusBanner() {
    ...
    if (status === 'Inactive' || status === 'Pending') {
        return (
            <div className="fixed top-20 left-0 lg:left-64 right-0 z-40 bg-red-500 text-white px-4 py-3 flex items-center justify-between">
    ...
    if (status === 'Trial') {
        return (
            <div className="fixed top-20 left-0 lg:left-64 right-0 z-40 bg-blue-500 text-white px-4 py-3 flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <span className="font-medium">
