...
export function PlaybooksTab({ onNavigate, startInCreateMode = false, initialPlaybookId }: PlaybooksTabProps) {
  ...
  const handleGeneratePlaybook = async () => {
    ...
    setTimeout(() => {
      const generated = {
        callScript: {
          openingLine: `Hi [Prospect Name], this is [Your Name] from [Company]. I noticed that your company is growing rapidly. Do you have a quick minute to discuss how we might help?`,
          discoveryQuestions: [
            `Can you walk me through your current process?`,
            `What impact is this having on your team's productivity?`,
            `Have you explored any solutions to address this challenge?`,
            `What would an ideal solution look like for your team?`,
            `If we could help you achieve [specific outcome], what would that mean for your business?`,
          ],
          objectionHandling: [
            {
              objection: "We're already working with another vendor",
              response:
                "I understand. Many of our best clients were working with competitors before switching. What if I could show you how we deliver specific value that your current vendor can't match?",
            },
            {
              objection: "We don't have budget right now",
              response:
                "I appreciate your honesty. Let me ask - if we could demonstrate ROI within a specific timeframe, would that change the conversation?",
            },
            {
              objection: "I need to think about it",
              response:
                "Absolutely, this is an important decision. To help you think it through, what specific concerns or questions do you have that I can address right now?",
            },
          ],
          closingStatement: `Based on what you've shared, it sounds like our solution could be a great fit for your team. I'd love to schedule a 30-minute demo to show you exactly how we can help. Does [Day] at [Time] work for you?`,
        },
        emailTemplates: {
          coldOutreach: `Subject: Quick question about [Pain Point] at [Company]

Hi [Prospect Name],

I noticed that [Company] is [relevant observation about their business]. Many companies we work with face similar challenges.

Our solution helps teams achieve [specific outcome].

Would you be open to a brief 15-minute call to explore if this could help your team?

Best regards,
[Your Name]`,
          followUp: `Subject: Following up - Solution for [Company]

Hi [Prospect Name],

I wanted to follow up on my previous message about helping companies solve [specific challenge].

I'd love to share a quick case study of how we helped [Similar Company] achieve [specific result].
...
[Your Name]`,
        ...
        voicemailScript: `Hi [Prospect Name], this is [Your Name] from [Company]. I'm calling because I work with companies to help them solve [specific challenge]. I'd love to share a quick idea that might help your team. My number is [Phone]. Again, that's [Phone]. Looking forward to connecting!`,
        discoveryFramework: {
          openEndedQuestions: [
            `Tell me about your current approach to [challenge]`,
            `What does success look like for your team?`,
            `Walk me through a typical day dealing with this challenge`,
            `How does this issue impact other areas of your business?`,
            `What have you tried so far to address this?`,
          ],
          keyValuePoints: [
            `Helps teams achieve specific outcomes`,
            `Designed for companies like yours`,
            `Addresses key challenges directly`,
            `Proven results with similar companies`,
            `Quick implementation and fast ROI`,
          ],
        },
        // Include valueInStoryForm in generated playbook
        valueInStoryForm: {
