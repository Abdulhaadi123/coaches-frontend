  ...
  return (
    <>
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 animate-in fade-in-50 duration-300 p-4">
        <Card className="w-full max-w-3xl max-h-[90vh] flex flex-col animate-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <div className="font-medium text-gray-900">25 minutes</div>
                </div>
              </div>
            </div>
